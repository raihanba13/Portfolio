...
explictly. An algorithm for nonSPD_CG is written where D should be automatically generated, but it has some unfixed bug and
...
Task i has implemented. The D matrix should
