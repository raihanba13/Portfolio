...
void local_T2N_calc(double local_a, int local_n, double h, double *local_T2N){
    int i;
    double step;
...
int main(int argc, char* argv[]){
    ...
    local_TN = ((func(local_a) + func(local_b)) / 2.0 + func(local_a+h)) * h; 
    ...
    while(fabs(S2N-T2N) >= tol){
        ...
        local_T2N_calc(local_a, local_n, h, &local_T2N);
